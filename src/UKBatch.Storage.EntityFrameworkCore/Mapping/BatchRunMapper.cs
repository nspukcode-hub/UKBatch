...
internal static class BatchRunMapper
{
    public static BatchRunEntity ToEntity(BatchRun model)
    {
        ...
        return new BatchRunEntity
        {
            ...
            CompensationStepIndex = model.CompensationStepIndex,
            RetryOfBatchId = model.RetryOfBatchId,
    ...
    public static BatchRun ToModel(BatchRunEntity e)
    {
        ...
        return new BatchRun
        {
            ...
            CompensationStepIndex = e.CompensationStepIndex,
            RetryOfBatchId = e.RetryOfBatchId,
